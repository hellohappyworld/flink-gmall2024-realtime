 ...
 * 创建日期：2024-05-07
 * 功能描述：交易域加购事务事实表
 * DWD_筛选加购事务表明细数据 https://www.bilibili.com/video/BV1dv421y7eu?p=58&vd_source=b6440733352819cc788f24606ec23fa3
 * DWD_加购事务事实表编写完成 https://www.bilibili.com/video/BV1dv421y7eu?p=59&vd_source=b6440733352819cc788f24606ec23fa3
 */
public class DwdTradeCartAdd extends BaseSQLApp {
    ...
    public Table filterCartAdd(StreamTableEnvironment tableEnv) {
        return tableEnv.sqlQuery("select \n" +
                ...
                "if(`type`='insert',cast(`data`['sku_num'] as bigint),cast(`data`['sku_num'] as bigint)-cast(`old`['sku_num'])) as sku_num,\n" +
