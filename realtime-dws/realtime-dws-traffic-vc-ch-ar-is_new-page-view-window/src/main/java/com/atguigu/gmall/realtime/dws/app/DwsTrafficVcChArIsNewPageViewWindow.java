 ...
 * 创建者：gml
 * 创建日期：2024-06-26
 * 功能描述：流量域各粒度(版本、渠道、地区、访客类别)页面浏览各窗口汇总表
 * 98_DWS_流量域各粒度用户页面访问窗口聚合得到独立访客和会话数  https://www.bilibili.com/video/BV1dv421y7eu?p=98&vd_source=b6440733352819cc788f24606ec23fa3
 * 99_DWS_流量域各粒度用户访问分组开窗聚合代码实现  https://www.bilibili.com/video/BV1dv421y7eu?p=99&vd_source=b6440733352819cc788f24606ec23fa3
...
public class DwsTrafficVcChArIsNewPageViewWindow extends BaseApp {
    ...
    public static void main(String[] args) {
        new DwsTrafficVcChArIsNewPageViewWindow().start(10022, 4, "dws-traffic-vc-ch-ar-is_new-page-view-window", Constant.TOPIC_DWD_TRAFFIC_PAGE);
    }
...
//        stream.print()
    ...
    public SingleOutputStreamOperator<TrafficPageViewBean> mapUvBean(SingleOutputStreamOperator<JSONObject> jsonObjStream) throws java.io.IOException {
        return jsonObjStream.keyBy(new KeySelector<JSONObject, String>() {
            ...
            public void open(Configuration parameters) throws Exception {
                ValueStateDescriptor<String> lastLoginDtDesc = new ValueStateDescriptor<String>("last_login_dt", String.class);
            ...
            public void processElement(JSONObject value, Context ctx, Collector<TrafficPageViewBean> out) throws Exception {
                ...
                out.collect(TrafficPageViewBean.builder()
                        ...
                        .ar(common.getString("vc"))
                        .ch(common.getString("vc"))
